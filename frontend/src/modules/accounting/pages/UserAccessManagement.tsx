  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">Add Company Access</h2>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {isLoadingAccesses ? (
              ...
              <tr>
                <td colSpan={4} className="px-6 py-4 text-center">No access records found</td>
              </tr>
            ) : (
              accesses.map(access => (
                <tr key={access.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 rounded-full text-xs ${access.permissions === 'write' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'}`}>
                      {access.permissions === 'write' ? 'Read & Write' : 'Read Only'}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
